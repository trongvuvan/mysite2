...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('catalog', '0008_bookinstance_borrow_day'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('borrow_day', models.DateField(blank=True, null=True)),
                ('status', models.CharField(blank=True, choices=[('w', 'Waiting'), ('a', 'Approved'), ('d', 'Denied')], default='w', help_text='Book availability', max_length=1)),
